...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BookReview',
            fields=[
                ('artice_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='multiple_inheritance.Artice')),
            ...
            bases=('multiple_inheritance.book', 'multiple_inheritance.artice'),
        ),
    ]
